...
import 'package:uguard_app/ui/auth/onBoarding/on_boarding_cubit.dart';
...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  final List<String> _subtitlesList = [
    'Make our community safer by taking on roles to be their guardian.',
    'Be there to protect your loved one\'s during an emergency.',
    'Easily locate your contacts in the time of need.',
    'Share your data with the people you trust.',
    'Create an accout and start making change!'
  ];

  /// list containing image paths or IconData representing the image of each page

  final List<dynamic> _imageList = [
    'assets/images/uguard.png',
