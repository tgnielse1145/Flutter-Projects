...
const GOOGLE_API_KEY = 'AIzaSyD3ix5v_gZCqlz674CcshqlDirm6UUOoh0';
...
class _PlaceOverviewScreenState extends State<PlaceOverviewScreen> {
 ...
 void _savePlace() {
  ...
  void getDirections()async{
    ...
    var url = Uri.parse(
        'https://maps.googleapis.com/maps/api/directions/json?origin=$initLat,$initLgt&destination=$finalLat,$finalLgt&key=AIzaSyD3ix5v_gZCqlz674CcshqlDirm6UUOoh0');
