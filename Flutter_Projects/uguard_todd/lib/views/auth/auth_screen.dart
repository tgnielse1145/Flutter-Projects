          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(0, 50, 125, 1).withOpacity(0.9),
                  Color.fromRGBO(220, 0, 0, 1).withOpacity(0.7),
                ],
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Flexible(
                    child: Container(
                      margin: EdgeInsets.all(10.0),//EdgeInsets.only(bottom: 20.0),
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            ...
                            Color.fromRGBO(0, 0, 0, 1).withOpacity(0.7),
                          ],
                        ),
                        borderRadius: BorderRadius.circular(20),
                        //color: Color.fromRGBO(200, 100, 50, 0.8),
