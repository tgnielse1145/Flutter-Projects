...
import 'package:uguard_app/views/search/progress_dialog.dart';
...
class _SearchScreenState extends State<SearchScreen>
{
 ...
 //List<String>placePredictionList=['fart','toilet','shit','monkeys'];

  @override
  Widget build(BuildContext context)
  {
   // String placeAddress = Provider.of<AppData>(context).pickUpLocation.placeName ?? "";
   String placeAddress = '1213 Massachusetts';
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Image.asset("assets/images/uGuard2.png", height: 16.0, width: 16.0,),
  ...
  void findPlace(String placeName) async
  {
    if(placeName.length > 1)
    {
      ...
      var res = await LocationController.getRequest(autoCompleteUrl);
...
class PlacePredictions{
  ...
  PlacePredictions.fromJson(Map<String,dynamic>json){
    ...
    secondary_text=json["structed_formatting"]["secondary_text"];
  }
}
...
class PredictionTile extends StatelessWidget 
{
  ...
  void getPlaceAddressDetails(String placeId, context) async
  {
    ...
    var res = await LocationController.getRequest(placeDetailsUrl);
    ...
    if(res["status"] == "OK")
    {
      ...
      Provider.of<Address>(context, listen: false).updateDropOffLocationAddress(address);
