...
class _EditUserScreenState extends State<EditUserScreen> {
  ...
  Future<void> _saveForm() async {
   ...
   if(_editedUser.id!=null){
     await Provider.of<UserController>(context, listen:false).updateUser(_editedUser.id!, _editedUser);
      ...
      //   id: Provider.of<AuthController>(context, listen: false).userId!,
      //   phone: _editedUser.phone,
      //   name: _editedUser.name,
      //   email: Provider.of<AuthController>(context, listen: false).userEmail!,  
            
      // );
        // }
         await Provider.of<UserController>(context,listen: false).addEditedUser(_editedUser);
      }catch(error){
        await showDialog(
          context: context,
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (userId != null) {
        _editedUser = Provider.of<UserController>(context, listen: false)
            .findById(userId);
        _initValues = {
          'name': _editedUser.name!,
          'phone': _editedUser.phone!,
