...
//            _buildConsumableBox(),
            ...
            Positioned(
              ...
              child: SmoothPageIndicator(
                ...
                effect: ScrollingDotsEffect(
                    dotWidth: 6,
                    dotHeight: 6,
                    dotColor: isDarkMode(context) ? Colors.grey : Colors.black54,
  ...
  Card _buildProductList() {
    ...
    final ListTile productHeader = ListTile(title: Text('Products for Sale'.tr()));
  ...
  Card _buildConsumableBox() {
    if (_loading) {
      return Card(
          child: (ListTile(
              leading: CircularProgressIndicator.adaptive(),
              title: Text('Fetching consumables...'.tr()))));
    }
    if (!_isAvailable || _notFoundIds.contains(_kConsumableId)) {
      return Card();
    }
    final ListTile consumableHeader =
        ListTile(title: Text('Purchased consumables'.tr()));
